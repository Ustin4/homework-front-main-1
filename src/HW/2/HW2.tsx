...
export const HW2 = () => {
  ...
  const filterUsers = () => {
    const filteredUsers = users.myFriends.filter(el=> el.address.city === 'LOS ANGELES' )/* 'НУЖНО ПРОФИЛЬТРОВАТЬ ДРУЗЕЙ. ОСТАВЛЯЕМ ТОЛЬКО ТЕХ, КОТОРЫЕ ЖИВУТ В ГОРОДЕ LOS ANGELES'*/;
